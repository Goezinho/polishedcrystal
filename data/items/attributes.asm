...
; HP UP
	item_attribute 1, 0, MON_HP_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PROTEIN
	item_attribute 1, 0, MON_ATK_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; IRON
	item_attribute 1, 0, MON_DEF_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CARBOS
	item_attribute 1, 0, MON_SPD_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CALCIUM
	item_attribute 1, 0, MON_SAT_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ZINC
	item_attribute 1, 0, MON_SDF_EV - MON_EVS, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RARE CANDY
