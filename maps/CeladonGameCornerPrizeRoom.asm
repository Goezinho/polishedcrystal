...
CELADONGAMECORNERPRIZEROOM_TM06_COINS EQU 1
CELADONGAMECORNERPRIZEROOM_TM68_COINS EQU 1
CELADONGAMECORNERPRIZEROOM_MR__MIME_COINS EQU 1
CELADONGAMECORNERPRIZEROOM_EEVEE_COINS    EQU 1
CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 1
